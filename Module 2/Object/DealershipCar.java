...
public class DealershipCar {
    ...
    public DealershipCar(String make, double price, int year, String color, String[] parts) {
        this.make = make;
        this.price = price;
        this.year = year;
        this.color = color;
    ...
    public DealershipCar(DealershipCar source) { // it invoke all the parameter once creating a object when one parameter pass in it
